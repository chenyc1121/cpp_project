...
const QVector<TileDef> BOARD_LAYOUT = {
    ...
    {TileType::ITERATOR,    "三教",     ColorGroup::NONE,       2000,   250,    0,      0,      0,      0,      0,      0,      "迭代器格", "迭代器格 — 拥有多个迭代器格可收取更高租金。\n\n拥有迭代器卡时，可在迭代器格之间传送：\n++（前进1格）| --（后退1格）\n+=2（前进2格）| -=2（后退2格）\n\n租金：1个=¥250 | 2个=¥500 | 3个=¥1000 | 4个=¥2000"},
    ...
    {TileType::ITERATOR,    "二教",     ColorGroup::NONE,       1500,   250,    0,      0,      0,      0,      0,      0,      "迭代器格", "迭代器格 — 拥有多个迭代器格可收取更高租金。\n\n拥有迭代器卡时，可在迭代器格之间传送。\n\n租金：1个=¥250 | 2个=¥500 | 3个=¥1000 | 4个=¥2000"},
    ...
    {TileType::ITERATOR,    "理教",     ColorGroup::NONE,       2000,   250,    0,      0,      0,      0,      0,      0,      "迭代器格", "迭代器格 — 拥有多个迭代器格可收取更高租金。\n\n拥有迭代器卡时，可在迭代器格之间传送。\n\n租金：1个=¥250 | 2个=¥500 | 3个=¥1000 | 4个=¥2000"},
    ...
    {TileType::ITERATOR,    "一教",   ColorGroup::NONE,       1500,   250,    0,      0,      0,      0,      0,      0,      "迭代器格", "迭代器格 — 拥有多个迭代器格可收取更高租金。\n\n拥有迭代器卡时，可在迭代器格之间传送。\n\n租金：1个=¥250 | 2个=¥500 | 3个=¥1000 | 4个=¥2000"},
