...
const QVector<TileDef> BOARD_LAYOUT = {
    ...
    {TileType::PROPERTY,    "铜锣湾",       ColorGroup::BROWN,      1200,   80,     220,    600,    1400,   1700,   2000,   800,    "棕色组",   "铜锣湾 — 棕色组地产。\n购买后可收取租金。拥有全部棕色组地产后租金翻倍，可建造房屋/旅馆。\n\n租金表：裸地¥80 | 1栋¥220 | 2栋¥600 | 3栋¥1400 | 4栋¥1700 | 旅馆¥2000\n建房费：¥800/栋"},
    ...
    {TileType::QA,          "问答格",       ColorGroup::NONE,       0,      0,      0,      0,      0,      0,      0,      0,      "问答",     "回答一道C++面向对象选择题。\n答对后有概率获得效果卡。\n答错无惩罚。"},
    {TileType::PROPERTY,    "徐家汇",       ColorGroup::PINK,       2000,   160,    440,    1050,   2300,   2700,   3200,   1200,   "粉色组",   "徐家汇 — 粉色组地产。\n购买后可收取租金。拥有全部粉色组地产后租金翻倍，可建造房屋/旅馆。\n\n租金表：裸地¥160 | 1栋¥440 | 2栋¥1050 | 3栋¥2300 | 4栋¥2700 | 旅馆¥3200\n建房费：¥1200/栋"},
    {TileType::UTILITY,     "电力公司",     ColorGroup::NONE,       1500,   0,      0,      0,      0,      0,      0,      0,      "设施",     "公共设施 — 按掷骰点数收取租金：\n拥有1个：租金 = 骰子点数 × 4\n拥有2个：租金 = 骰子点数 × 10"},
    {TileType::PROPERTY,    "静安寺",       ColorGroup::PINK,       2000,   160,    440,    1050,   2300,   2700,   3200,   1200,   "粉色组",   "静安寺 — 粉色组地产。\n购买后可收取租金。拥有全部粉色组地产后租金翻倍，可建造房屋/旅馆。\n\n租金表：裸地¥160 | 1栋¥440 | 2栋¥1050 | 3栋¥2300 | 4栋¥2700 | 旅馆¥3200\n建房费：¥1200/栋"},
    ...
    {TileType::PROPERTY,    "王府井",       ColorGroup::PINK,       2200,   180,    500,    1100,   2500,   3000,   3500,   1200,   "粉色组",   "王府井 — 粉色组地产。\n购买后可收取租金。拥有全部粉色组地产后租金翻倍，可建造房屋/旅馆。\n\n租金表：裸地¥180 | 1栋¥500 | 2栋¥1100 | 3栋¥2500 | 4栋¥3000 | 旅馆¥3500\n建房费：¥1200/栋"},
    {TileType::PROPERTY,    "三里屯",       ColorGroup::ORANGE,     2400,   200,    550,    1250,   2700,   3200,   3800,   1400,   "橙色组",   "三里屯 — 橙色组地产。\n购买后可收取租金。拥有全部橙色组地产后租金翻倍，可建造房屋/旅馆。\n\n租金表：裸地¥200 | 1栋¥550 | 2栋¥1250 | 3栋¥2700 | 4栋¥3200 | 旅馆¥3800\n建房费：¥1400/栋"},
    {TileType::QA,          "问答格",       ColorGroup::NONE,       0,      0,      0,      0,      0,      0,      0,      0,      "问答",     "回答一道C++面向对象选择题。\n答对后有概率获得效果卡。\n答错无惩罚。"},
    {TileType::PROPERTY,    "国贸中心",     ColorGroup::ORANGE,     2400,   200,    550,    1250,   2700,   3200,   3800,   1400,   "橙色组",   "国贸中心 — 橙色组地产。\n购买后可收取租金。拥有全部橙色组地产后租金翻倍，可建造房屋/旅馆。\n\n租金表：裸地¥200 | 1栋¥550 | 2栋¥1250 | 3栋¥2700 | 4栋¥3200 | 旅馆¥3800\n建房费：¥1400/栋"},
    {TileType::TAX,         "奢侈税",       ColorGroup::NONE,       3000,   0,      0,      0,      0,      0,      0,      0,      "税务",     "停留在此格需缴纳奢侈税¥3000。"},
    {TileType::RAILROAD,    "北京南站",     ColorGroup::NONE,       2000,   250,    0,      0,      0,      0,      0,      0,      "车站",     "拥有多个车站可收取更高的租金：\n1个=¥250 | 2个=¥500 | 3个=¥1000 | 4个=¥2000"},
    ...
    {TileType::QA,          "问答格",       ColorGroup::NONE,       0,      0,      0,      0,      0,      0,      0,      0,      "问答",     "回答一道C++面向对象选择题。\n答对后有概率获得效果卡。\n答错无惩罚。"},
    {TileType::PROPERTY,    "宽窄巷子",     ColorGroup::RED,        2800,   240,    700,    1500,   3100,   3600,   4300,   1600,   "红色组",   "宽窄巷子 — 红色组地产。\n购买后可收取租金。拥有全部红色组地产后租金翻倍，可建造房屋/旅馆。\n\n租金表：裸地¥240 | 1栋¥700 | 2栋¥1500 | 3栋¥3100 | 4栋¥3600 | 旅馆¥4300\n建房费：¥1600/栋"},
    {TileType::PROPERTY,    "锦里",         ColorGroup::RED,        2800,   240,    700,    1500,   3100,   3600,   4300,   1600,   "红色组",   "锦里 — 红色组地产。\n购买后可收取租金。拥有全部红色组地产后租金翻倍，可建造房屋/旅馆。\n\n租金表：裸地¥240 | 1栋¥700 | 2栋¥1500 | 3栋¥3100 | 4栋¥3600 | 旅馆¥4300\n建房费：¥1600/栋"},
    {TileType::UTILITY,     "自来水公司",   ColorGroup::NONE,       1500,   0,      0,      0,      0,      0,      0,      0,      "设施",     "公共设施 — 按掷骰点数收取租金：\n拥有1个：租金 = 骰子点数 × 4\n拥有2个：租金 = 骰子点数 × 10"},
